      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription>Start your YouTube growth journey today</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="flex items-start gap-2">
                <input
                  ...
                  className="mt-1 accent-yt-red"
                />
                <Label htmlFor="agree" className="text-xs text-muted-foreground leading-relaxed">
                  I agree to the{' '}
                  <button type="button" onClick={() => navigate('terms-of-service')} className="text-yt-red hover:underline">
                    Terms of Service
                  </button>{' '}
                  and{' '}
                  <button type="button" onClick={() => navigate('privacy-policy')} className="text-yt-red hover:underline">
                    Privacy Policy
                  </button>
                </Label>
              </div>
